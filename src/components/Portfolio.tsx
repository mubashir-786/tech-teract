...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Medical dashboard for patient management and analytics',
    ...
    },
    {
      ...
      tags: ['React Native', 'Firebase', 'WebSocket', 'D3.js'],
    ...
    },
    {
      ...
      tags: ['Angular', 'Express', 'Socket.io', 'Redis'],
        ...
        <div ref={sectionRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => {
            ...
            return (
              <div
                key={index}
                className={`portfolio-item group relative bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden hover:border-purple-500/50 transition-all duration-700 transform hover:scale-105 hover:-translate-y-3 ${
                  isItemVisible ? 'opacity-100 translate-y-0 rotate-0' : 'opacity-0 translate-y-20 rotate-2'
                }`}
                style={{
